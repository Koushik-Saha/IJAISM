...
const mockBlogs = [
  {
    ...
    content: `
      ...
      <div style="text-align: center; margin: 2rem 0;">
          <img src="/images/hero/community.png" alt="Quantum Processor" style="max-width: 100%; border-radius: 8px;"/>
  ...
  },
  {
    ...
    content: `
      ...
      <div style="text-align: center; margin: 2rem 0;">
          <img src="/images/hero/global_network.png" alt="Network towers" style="max-width: 100%; border-radius: 8px;"/>
      </div>
  ...
  },
  {
    ...
    content: `
      ...
      <div style="text-align: center; margin: 2rem 0;">
          <img src="/images/hero/peer_review.png" alt="Circuit board resembling brain" style="max-width: 100%; border-radius: 8px;"/>
      </div>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <div style="text-align: center; margin: 2rem 0;">
          <img src="/images/hero/open_access.png" alt="DNA representation" style="max-width: 100%; border-radius: 8px;"/>
      </div>
  ...
  },
  {
    ...
    content: `
      ...
      <div style="text-align: center; margin: 2rem 0;">
          <img src="/images/hero/peer_review.png" alt="Drone over field" style="max-width: 100%; border-radius: 8px;"/>
      </div>
