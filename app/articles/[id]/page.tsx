...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  try {
    ...
    console.warn("Database connection failed during metadata generation:", error);
    return {
      title: "Article | C5K Platform",
      description: "Academic article platform",
    };
  }
}
...
export default async function ArticleDetailPage({ params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    console.error("Database connection failed during page generation:", error);
    notFound();
  }
}
