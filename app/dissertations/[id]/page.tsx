            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              {dissertation.coverImageUrl && (
                <div className="mb-8 p-4 bg-gray-50 rounded-lg flex justify-center">
                  <img
                    src={dissertation.coverImageUrl.startsWith('http') || dissertation.coverImageUrl.startsWith('/') ? dissertation.coverImageUrl : `https://c5k.com/public/backend/thesis/${dissertation.coverImageUrl.replace(/^\//, '')}`}
