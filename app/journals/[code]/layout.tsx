                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                        ...
                        <div className="w-48 h-64 bg-white rounded-sm shadow-xl flex-shrink-0 overflow-hidden relative border-4 border-white/20">
                            {journal.coverImageUrl ? (
                                <img
                                    src={journal.coverImageUrl.startsWith('http') || journal.coverImageUrl.startsWith('/') ? journal.coverImageUrl : `https://c5k.com/public/backend/journal/${journal.coverImageUrl.replace(/^\//, '')}`}
                                    alt={journal.code}
